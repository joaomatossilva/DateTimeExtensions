...
namespace DateTimeExtensions.Tests
{
	...
	public class en_NZCalendarTest
	{
		...
		public void DayAfterNewYearsDay()
		{
			...
			var dateOnGregorian = new DateTime(2013, 1, 2); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2014, 1, 2); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2015, 1, 2); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2016, 1, 4); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2017, 1, 2); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2018, 1, 2); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2019, 1, 2); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2020, 1, 2); TestHoliday(workingDayCultureInfo, dateOnGregorian);
		}
		...
		public void BoxingDay()
		{
			...
			var dateOnGregorian = new DateTime(2013, 12, 26); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2014, 12, 26); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2015, 12, 28); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2016, 12, 26); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2017, 12, 26); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2018, 12, 26); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2019, 12, 26); TestHoliday(workingDayCultureInfo, dateOnGregorian);
			dateOnGregorian = new DateTime(2020, 12, 28); TestHoliday(workingDayCultureInfo, dateOnGregorian);
		}
