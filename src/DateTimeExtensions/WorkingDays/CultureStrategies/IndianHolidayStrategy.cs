...
namespace DateTimeExtensions.WorkingDays.CultureStrategies
{
    ...
    public class IndianHolidayStrategy : HolidayStrategyBase
    {
        ...
        public IndianHolidayStrategy()
        {
            ...
            this.InnerHolidays.Add(GlobalHolidays.Christmas);
        ...
        private static Holiday MahaShivaratri => new FixedHoliday("Maha Shivaratri", 3, 8, IndianCalendar); // Moves around
        private static Holiday Holi => new FixedHoliday("Holi", 3, 25, IndianCalendar); // Approx date
        private static Holiday GoodFriday => new VariableHoliday("Good Friday", year => EasterCalculator.GetGoodFriday(year), IndianCalendar);
        private static Holiday MahavirJayanti => new FixedHoliday("Mahavir Jayanti", 4, 21, IndianCalendar);
        private static Holiday EidUlFitr => new VariableHoliday("Eid-ul-Fitr", year => IslamicCalendarHelper.CalculateEidUlFitr(year));
        private static Holiday EidUlAdha => new VariableHoliday("Eid-ul-Adha", year => IslamicCalendarHelper.CalculateEidUlAdha(year));
        ...
        private static Holiday EidMiladUnNabi => new VariableHoliday("Eid Milad-un-Nabi", year => IslamicCalendarHelper.CalculateEidMiladUnNabi(year));
