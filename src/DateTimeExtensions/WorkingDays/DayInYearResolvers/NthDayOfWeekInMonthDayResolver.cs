...
namespace DateTimeExtensions.WorkingDays.DayInYearResolvers
{
    ...
    /// <summary>
    /// Representation of a calendar day that is the nth occurrence of a given day of week in a given month.
    /// </summary>
    public class NthDayOfWeekInMonthDayResolver : IDayResolver
    {
        ...
        public NthDayOfWeekInMonthDayResolver(int count, DayOfWeek dayOfWeek, int month, CountDirection direction)
        {
            this.count = count;
