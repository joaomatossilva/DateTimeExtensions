	...
	public class EN_NZHolidayStrategy : HolidayStrategyBase, IHolidayStrategy
	{
		...
		public static Holiday QueensBirthday
		{
			get
			{
				...
				{
					queensBirthday = new NthDayOfWeekInMonthHoliday("Queen's Birthday", 1, DayOfWeek.Monday, 6, CountDirection.FromFirst);
				}
		...
		public static Holiday LabourDay
		{
			get
			{
				if (labourDay == null)
				{
					labourDay = new NthDayOfWeekInMonthHoliday("Labour Day", 4, DayOfWeek.Monday, 10, CountDirection.FromFirst);
				}
				return labourDay;
			}
		}
